	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'size_units' => ['px'],
				'selectors'  => [
					'.bdt-table-of-content .nav li a, .bdt-table-of-content .nav>.nav li a' => 'padding: {{SIZE}}{{UNIT}} 0;',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'#bdt-toc-{{ID}} .nav > li > a' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::SWITCHER,
				'selectors' => [
					'#bdt-toc-{{ID}} .nav > li > a' => 'text-decoration: underline',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'#bdt-toc-{{ID}} .nav > li > a:hover' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::SWITCHER,
				'selectors' => [
					'#bdt-toc-{{ID}} .nav > li > a:hover' => 'text-decoration: underline',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'#bdt-toc-{{ID}} .nav > li.bdt-active > a' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::SWITCHER,
				'selectors' => [
					'#bdt-toc-{{ID}} .nav > li.bdt-active > a' => 'text-decoration: underline',
				],
			]
		);
